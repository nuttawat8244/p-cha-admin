...
if (isset($_GET['Subject'])) {
    ...
    $result = $controller->showdata_receive($Subject, $Section);
...
<body>
    <div class="head">
      <div>
        <a href="index.php"><h3>Receive Requirement <?php echo $Section; ?></h3></a>
      </div>
      <div id="login">
        <div>
    ...
    <h1 class="text-center mt-5">Receive Job <?php echo $Section; ?></h1>
            ...
            <tbody>
                ...
                while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                  ...
                  <tr>
                        ...
                        <td class=""><?php echo $row['Receive']; ?> </td>
                        <td class=""><?php echo $row['Receive_date']; ?> </td>
