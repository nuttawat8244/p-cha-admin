...
if (isset($_POST["save"])) {
    ...
    $Addjob_Production = $controller->Addjob($Date, $Subject, $Problem, $Requirement, $Request_by, $Receive,  $Finish, $Sub, $Department, $Section);

    require_once "../mail.php";


    if ($Addjob_Production) {
...
if (isset($_POST['sub'])) {
    ...
    $Addsub_Production = $controller->Addsub($Date, $Subject, $Problem, $Requirement, $Request_by, $Receive, $Finish, $Department, $Section);

    require_once "../mail_sub.php";

    if ($Addsub_Production) {
...
<body>
    ...
    <body>
        ...
        <h1 class="text-center mt-4">Job Production</h1>
        ...
        <form action="Production.php" method="post" class="p-2">
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <!-- <a href="../Detail_job.php?Subject=<?php echo $row['Subject']; ?>&Department=Production &Section=Production" name="detail" class="btn btn-secondary mb-1 ">Detail</a> -->
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header bg-primary text-white">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Job Production Requirement </h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form class=" " action="Production.php" method="post">
                            <div class="d-flex justify-content-start w-50 ">
                                ...
                                <div class="col-md-4 position-relative m-2">
                                    ...
                                    <input type="text" readonly class="form-control text-center" value="Production" name="Department">
                                </div>
                                <div class="col-md-4 position-relative m-2">
                                    <label for="validationTooltipUsername" class="form-label">Section</label>
                                    <input type="text" readonly class="form-control text-center" value="Production" name="Section">
                                </div>
                            </div>
                            <div class=" mt-3">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header bg-secondary text-white">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">SubJob Production Requirement </h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form class=" " action="Production.php" method="post">
