    ...
    <!-- <div class="container table"> -->
        <table id="example" class="table table-striped table-bordered" width="100%">
            <div class="d-flex justify-content-end">
                ...
                <button type="submit" class="btn btn-primary btn-sm m-1"  name="Finish">Receive</button>
            </div>
            ...
            <tbody>
                ...
                while (@$row = @$result->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    $valuereceive = $row['Receive'];
                    $isDisabled = $valuereceive === 'Y' ? 'disabled' : '';
                        if($finishValue === "N"){
                    ...
                    <tr>
                        ...
                        <td> <a href="<?php echo $detail; ?>" class="btn <?php echo $btn; ?>"> <?php echo $row['Finish']; ?></a> </td>
