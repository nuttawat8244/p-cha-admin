...
if (isset($_POST["save"])) {
    ...
    // echo " $Request_by";
    $link_receive = "http://localhost:8081/p-cha/" . "receive.php?Subject=" . $Subject . "&Section=" . $Section;
    // $link_receive = "https://booking-room.ucc.co.th/p-cha/"."recieve.php?Subject=".$Subject."&Section=".$Section;

    // $link_receive = "http://localhost/p-cha/"."receive.php?Subject=".$Subject."&Section=".$Section;

    $Addjob_Business_Analysis = $controller->Addjob($Date, $Subject, $Problem, $Requirement, $Request_by, $Receive,  $Finish, $Sub, $Department, $Section);

    require_once "../mail.php";


    if ($Addjob_Business_Analysis) {
...
if (isset($_POST['sub'])) {
    ...
    $link_receive = "http://localhost:8081/p-cha/" . "receive.php?Subject=" . $Subject . "&Section=" . $Section;
    // $link_receive = "https://booking-room.ucc.co.th/p-cha/"."recieve.php?Subject=".$Subject."&Section=".$Section;
    // $link_receive = "http://localhost/p-cha/"."receive_sub.php?Subject=".$Subject."&Section=".$Section;


    $Addsub_Business_Analysis = $controller->Addsub($Date, $Subject, $Problem, $Requirement, $Request_by, $Receive, $Finish, $Department, $Section);

    require_once "../mail_sub.php";

    if ($Addsub_Business_Analysis) {
...
if (isset($_POST['Receive'])) {
    ...
    if (!empty($_POST["ids"])) {
        ...
        $update = $controller->recieve_job($all);
        foreach ($ids as $ID) {
            $row = $controller->mail_checkbox($ID);
...
<body>
    ...
    <body>
        <div class="head">
            <div>
                <a href="../index.php">
                    <h3>Business Analysis Requirement</h3>
                </a>
            </div>
            <div id="login">
                <div>
        ...
        <h1 class="text-center mt-4">Job Business Analysis</h1>
        ...
        <form action="Business Analysis.php" method="post" class="p-2">
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td >
                                    ...
                                    <!-- <a href="../Detail_job.php?Subject=<?php echo $row['Subject']; ?>&Department=Admin1 &Section=Business Analysis" name="detail" class="btn btn-secondary mb-1 ">Detail</a> -->
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header bg-primary text-white">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Job Business Analysis Requirement </h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form class=" " action="Business Analysis.php" method="post">
                            <div class="d-flex justify-content-start w-50 ">
                                ...
                                <div class="col-md-4 position-relative m-2">
                                    ...
                                    <input type="text" readonly class="form-control text-center" value="Admin1" name="Department">
                                </div>
                                <div class="col-md-4 position-relative m-2">
                                    <label for="validationTooltipUsername" class="form-label">Section</label>
                                    <input type="text" readonly class="form-control text-center" value="Business Analysis" name="Section">
                                </div>
                            </div>
                            <div class=" mt-3">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header bg-secondary text-white">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">SubJob Business Analysis Requirement </h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form class=" " action="Business Analysis.php" method="post">
