...
<body>
    ...
    <body>
        ...
        <form action="General2.php" method="post" class="p-2">
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td >
                                    ...
                                    <!-- <a href="../Detail_job.php?Subject=<?php echo $row['Subject']; ?>&Department=Sale &Section=General2" name="detail" class="btn btn-secondary mb-1 ">Detail</a> -->
