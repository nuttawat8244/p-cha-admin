...
if (isset($_POST["save"])) {
    ...
    $Addjob_Auto2 = $controller->Addjob($Date, $Subject, $Problem, $Requirement, $Request_by, $Receive,  $Finish, $Sub, $Department, $Section);
...
if (isset($_POST['sub'])) {
    ...
    $Addsub_Auto2 = $controller->Addsub($Date, $Subject, $Problem, $Requirement, $Request_by, $Receive, $Finish, $Department, $Section);
...
<body>
    ...
    <body>
        ...
        <h1 class="text-center mt-4">Job Auto2</h1>
        ...
        <form action="Auto2.php" method="post" class="p-2">
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <!-- <a href="../Detail_job.php?Subject=<?php echo $row['Subject']; ?>&Department=Sale &Section=Auto2" name="detail" class="btn btn-secondary mb-1 ">Detail</a> -->
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header bg-primary text-white">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Job Auto2 Requirement </h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form class=" " action="Auto2.php" method="post">
                            <div class="d-flex justify-content-start w-50 ">
                                ...
                                <div class="col-md-4 position-relative m-2">
                                    ...
                                    <input type="text" readonly class="form-control text-center" value="Auto2" name="Section">
                                </div>
                            </div>
                            <div class=" mt-3">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header bg-secondary text-white">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">SubJob Auto2 Requirement </h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form class=" " action="Auto2.php" method="post">
