...
$back = 'Detail_job.php?Subject=' . $Subject . '&Department=' . $Department . '&Section=' . $Section;


    $result = $controller->showdetail_sub($ID);
    $result2 = $controller->showdetail_sub($ID);
...
if (isset($_POST['Finish'])) {
    ...
    if (!empty($_POST["ids"])) {
        ...
        foreach ($ids as $ID) {
            ...
            $link = "https://booking-room.ucc.co.th/p-cha/requirement_detail.php?ID=$ID_main&Subject=$Subject";
            require_once "mail_finish_sub.php";
            $Problem = "";
        }


        $result = $controller->showdetail_sub($all);
        $result2 = $controller->showdetail_sub($all);
...
<body>
    ...
    <form class=" " action="finish_sub.php" method="post">

    <!-- <div class="container table"> -->
        <table id="example" class="table table-striped table-bordered" width="100%">
            <div class="d-flex justify-content-end">
                <!-- <a href="http://http://localhost:8081/p-cha-admin/Detail_job.php?Subject=GA%20TEST&Department=Admin2%20&Section=GA"></a> -->
                <a href="<?php echo $back; ?>" class="btn btn-secondary btn-sm m-1">Back</a>
            ...
            <tbody>
                ...
                while (@$row = @$result->fetch(PDO::FETCH_ASSOC)) { 
                    ...
                    ?>
                    <input type="text" name="ID" value="<?php echo $row['Sub_id']; ?>"hidden  >
                    <input type="text" name="ID_main" value="<?php echo $row['ID']; ?>"hidden  >
